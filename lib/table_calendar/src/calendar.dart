...
class _TableCalendarState extends State<TableCalendar>
  ...
  void didUpdateWidget(TableCalendar oldWidget) {
    ...
    if (oldWidget.donedaysC != widget.donedaysC) {
      widget.calendarController._donedaysCC = widget.donedaysC;
    }

    if (oldWidget.iconC != widget.iconC) {
      widget.calendarController._iconCC = widget.iconC;
    }
  ...
  Widget _buildCellContent(DateTime date) {
    ...
    final tIsDone = widget.calendarController.isDone(date);
    final tIsDV = widget.calendarController.isDV;
    final tIconC = widget.calendarController.iconCC;
    ...
    final isDone = widget.builders.todayDayBuilder != null && tIsDone;
    final iconC = widget.builders.todayDayBuilder != null && tIconC!=null;
