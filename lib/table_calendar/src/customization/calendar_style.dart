...
class CalendarStyle {
  ...
  const CalendarStyle({
    ...
    this.selectedColor = const Color(0xFFFF7043), // Material indigo[400]
    this.todayColor = const Color(0xFFFFAB91), // Material indigo[200]
    this.markersColor = const Color(0xFF5D4037), // Material blueGrey[900]
