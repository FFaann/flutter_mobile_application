...
class CalendarController {
  ...
  List get doneDaysCC => _donedaysCC;
  IconData get iconCC => _iconCC;
  bool get isDV=> _isDV;
  /// Currently visible calendar format.
  CalendarFormat get calendarFormat => _calendarFormat.value;

  /// List of currently visible days.
  List get visibleDays =>
  ...
  ValueNotifier<List> _visibleDays;
  ...
  void _init({
    ...
    @required List donedaysCC,
    @required IconData iconCC,
    @required bool isDV,
  ...
  bool isToday(DateTime day) {
    ...
    /// Returns true if `day` is the same day as `DateTime.now()`.
  bool isDone(DateTime day) {
    // print(doneDaysCC.toString()+DateTime(day.year,day.month,day.day).toString()+doneDaysCC.contains(DateTime(day.year,day.month,day.day)).toString());
    return (doneDaysCC.contains(DateTime(day.year,day.month,day.day)));
  }
